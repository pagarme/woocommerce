...
class Payment
{
	...
	public function pay_credit_card( $wc_order, $form_fields, $customer)
    {
		...
		$card_amount  = $this->_get_price_with_interest( $wc_order->get_total(), $card_installments );
    ...
    public function pay_2_cards( $wc_order, $form_fields, $customer )
    {
		...
		$card1_amount = $this->_get_price_with_interest( $card1_amount, $card1_installments );
		$card2_amount = $this->_get_price_with_interest( $card2_amount, $card2_installments );
