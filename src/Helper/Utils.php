...
class Utils
{
     ...
     * Validate CNPJ
     *
     * @param string $document The CNPJ to validate
     *
     * @return bool Returns true if CNPJ is valid, false otherwise
     */
    public static function isValidCnpj(string $document): bool
    {
        ...
        $cnpjCleaned = strtoupper(self::only_alphanumeric($document));
        ...
        if(self::hasAllEqualCharacters($cnpjCleaned)) {
            return false;
        }
     ...
     *
     * @return bool Returns true if CPF is valid, false otherwise
     */
    public static function isValidCpf(string $cpf): bool
    {
        ...
        // Keep only numbers
        $cpfCleaned = self::only_numbers($cpf);
        ...
        if (self::hasAllEqualCharacters($cpfCleaned)) {
            return false;
        }
