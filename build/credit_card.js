...
const Card = ({
  ...
  const {
    ...
    walletId,
    errors
  } = (0,_useCard__WEBPACK_IMPORTED_MODULE_7__["default"])(cardIndex, eventRegistration, backendConfig);
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(LoadingMask, {
    isLoading: isLoading
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "wc-block-components-form"
  }, backendConfig?.walletEnabled && backendConfig?.cards?.length > 0 && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_inputs_components_Wallet__WEBPACK_IMPORTED_MODULE_6__["default"], {
    label: walletLabel,
    ...
    setBrand: setBrand
  }), walletId.length === 0 && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_inputs_components_InputHolderName__WEBPACK_IMPORTED_MODULE_2__["default"], {
  ...
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_inputs_components_InputNumber__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...
    setErrors: setErrors,
    fieldErrors: backendConfig?.fieldErrors
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_inputs_components_InputExpiry__WEBPACK_IMPORTED_MODULE_4__["default"], {
    ...
    setErrors: setErrors,
    fieldErrors: backendConfig?.fieldErrors
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_inputs_components_InputCvv__WEBPACK_IMPORTED_MODULE_5__["default"], {
    ...
    setErrors: setErrors,
    fieldErrors: backendConfig?.fieldErrors
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_inputs_components_Installments__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    setIsLoading: setIsLoading,
    cardIndex: cardIndex
  }), walletId.length === 0 && backendConfig?.walletEnabled && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(CheckboxControl, {
    label: saveCardLabel,
    checked: saveCard,
...
Card.propType = {
  billing: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().object).isRequired,
  components: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().object).isRequired,
  backendConfig: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().object).isRequired,
  cardIndex: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().number).isRequired,
  eventRegistration: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().object).isRequired
};
...
const InputCvv = ({
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_MaskedInput__WEBPACK_IMPORTED_MODULE_1__["default"], {
    id: id,
    label: label,
    mask: "9999",
    ...
    errors: errors
  }), errors.inputCvv && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "wc-block-components-validation-error",
    role: "alert"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, errors.inputCvv)));
};
InputCvv.propTypes = {
  ...
  fieldErrors: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().object).isRequired
};
...
const InputExpiry = ({
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_MaskedInput__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    errors: errors
  }), errors.inputExpiry && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "wc-block-components-validation-error",
    role: "alert"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, errors.inputExpiry)));
};
...
const InputHolderName = ({
  ...
  }), errors.inputHolderName && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "wc-block-components-validation-error",
    role: "alert"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, errors.inputHolderName)));
};
InputHolderName.propTypes = {
  ...
  fieldErrors: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().object).isRequired
};
...
const InputNumber = ({
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    htmlFor: id
  }, label), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)((react_input_mask__WEBPACK_IMPORTED_MODULE_1___default()), {
    ...
    value: inputValue,
    onBlur: inputBlurHandler
  }), brandImageSrc && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
    src: brandImageSrc,
    alt: brand
  }), errors.inputNumber && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "wc-block-components-validation-error",
    role: "alert"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, errors.inputNumber)));
};
...
const Installments = ({
  ...
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(ComboboxControl, {
...
MaskedInput.propTypes = {
  ...
  validate: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().func).isRequired,
  validateIndex: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().string).isRequired,
  errors: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().object).isRequired
};
...
/* harmony import */ var _useCardValidation__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./useCardValidation */ "./assets/javascripts/front/reactCheckout/payments/Card/useCardValidation.js");
/* jshint esversion: 8 */
...
const useCard = (cardIndex, eventRegistration, backendConfig) => {
  ...
  const {
    validateAllFields
  } = (0,_useCardValidation__WEBPACK_IMPORTED_MODULE_3__["default"])(cardIndex, errors, setErrors, backendConfig.fieldErrors);
  const {
  ...
  }, [onCheckoutValidation, holderName, number, expirationDate, cvv, backendConfig, walletId]);
  return {
    isLoading,
    setIsLoading,
    setHolderName,
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _inputs_utils_expirationDate__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./inputs/utils/expirationDate */ "./assets/javascripts/front/reactCheckout/payments/Card/inputs/utils/expirationDate.js");
/* jshint esversion: 9 */
...
const useCardValidation = (cardIndex, errors, setErrors, fieldErrors) => {
  ...
  const validateExpiry = (value, errors) => {
    ...
    const [expiryMonth, expiryYear] = (0,_inputs_utils_expirationDate__WEBPACK_IMPORTED_MODULE_0__.getMonthAndYearFromExpirationDate)(value);
...
/* harmony import */ var _Card__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Card */ "./assets/javascripts/front/reactCheckout/payments/Card/index.js");
/* harmony import */ var _useCreditCard__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./useCreditCard */ "./assets/javascripts/front/reactCheckout/payments/CreditCard/useCreditCard.js");
...
const PagarmeCreditCardComponent = props => {
  ...
  (0,_useCreditCard__WEBPACK_IMPORTED_MODULE_3__["default"])(backendConfig, emitResponse, eventRegistration);
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Card__WEBPACK_IMPORTED_MODULE_2__["default"], (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, props, {
...
PagarmeCreditCardComponent.propTypes = {
  emitResponse: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().object),
  eventRegistration: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().object)
};
PagarmeCreditCardLabel.propTypes = {
  components: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().object)
};
const pagarmeCreditCardPaymentMethod = {
  name: backendConfig.name,
  label: (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(PagarmeCreditCardLabel, null),
  content: (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(PagarmeCreditCardComponent, null),
  edit: (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(PagarmeCreditCardComponent, null),
  canMakePayment: () => true,
