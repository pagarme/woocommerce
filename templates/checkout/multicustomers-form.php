    ...
    <div class="multicustomer">
        <p class="form-row form-row-wide">
            <label>
                ...
                <input name="multicustomer_<?php echo $type; ?><?php echo isset($suffix) ? $suffix : ''; ?>[name]" data-required="true" class="input-text">
            </label>
        </p>
        <p class="form-row form-row-wide">
            <label>
                <?php esc_html_e('Email', 'woo-pagarme-payments'); ?> <span class="required">*</span>
                <input name="multicustomer_<?php echo $type; ?><?php echo isset($suffix) ? $suffix : ''; ?>[email]" data-required="true" type="email" class="input-text">
            </label>
        </p>
        <p class="form-row form-row-wide">
            <label>
                <?php esc_html_e('CPF', 'woo-pagarme-payments'); ?> <span class="required">*</span>
                <input name="multicustomer_<?php echo $type; ?><?php echo isset($suffix) ? $suffix : ''; ?>[cpf]" data-required="true" data-mask="000.000.000-00" class="input-text">
            </label>
        </p>
        <p class="form-row form-row-first">
            <label>
                <?php esc_html_e('Zip Code', 'woo-pagarme-payments'); ?> <span class="required">*</span>
                <input name="multicustomer_<?php echo $type; ?><?php echo isset($suffix) ? $suffix : ''; ?>[zip_code]" data-required="true" data-mask="00000-000" class="input-text">
            </label>
        </p>
        <p class="form-row form-row-last">
            <label>
                <?php esc_html_e('Street', 'woo-pagarme-payments'); ?> <span class="required">*</span>
                <input name="multicustomer_<?php echo $type; ?><?php echo isset($suffix) ? $suffix : ''; ?>[street]" data-required="true" class="input-text">
            </label>
        </p>
        <p class="form-row form-row-first">
            <label>
                <?php esc_html_e('Number', 'woo-pagarme-payments'); ?> <span class="required">*</span>
                <input name="multicustomer_<?php echo $type; ?><?php echo isset($suffix) ? $suffix : ''; ?>[number]" data-required="true" class="input-text">
            </label>
        </p>
        <p class="form-row form-row-last">
            <label>
                <?php esc_html_e('Neighborhood', 'woo-pagarme-payments'); ?> <span class="required">*</span>
                <input name="multicustomer_<?php echo $type; ?><?php echo isset($suffix) ? $suffix : ''; ?>[neighborhood]" data-required="true" class="input-text">
            </label>
        </p>
        <p class="form-row form-row-wide">
            <label>
                <?php esc_html_e('Complement', 'woo-pagarme-payments'); ?>
                <input name="multicustomer_<?php echo $type; ?><?php echo isset($suffix) ? $suffix : ''; ?>[complement]" class="input-text">
            </label>
        </p>
        <p class="form-row form-row-first">
            <label>
                <?php esc_html_e('City', 'woo-pagarme-payments'); ?> <span class="required">*</span>
                <input name="multicustomer_<?php echo $type; ?><?php echo isset($suffix) ? $suffix : ''; ?>[city]" data-required="true" class="input-text">
            </label>
        </p>
        <p class="form-row form-row-last">
            <label>
