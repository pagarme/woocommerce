...
class GetAccountResponse implements JsonSerializable
{
    ...
    public function jsonSerialize()
    {
        ...
        $json['domains']                          = isset($this->domains) ? $this->domains : null;
        $json['antifraud_settings']               = isset($this->domains) ? $this->antifraudSettings : null;
        $json['mundipagg_settings']               = isset($this->domains) ? $this->mundipaggSettings : null;
        $json['pagarme_settings']                 = isset($this->domains) ? $this->pagarmeSettings : null;
        $json['credit_card_settings']             = isset($this->domains) ? $this->creditCardSettings : null;
        $json['debit_card_settings']              = isset($this->domains) ? $this->debitCardSettings : null;
        $json['voucher_settings']                 = isset($this->domains) ? $this->voucherSettings : null;
        $json['boleto_settings']                  = isset($this->domains) ? $this->boletoSettings : null;
        $json['bank_transfer_settings']           = isset($this->domains) ? $this->bankTransferSettings : null;
        $json['wallet_settings']                  = isset($this->domains) ? $this->walletSettings : null;
        $json['safetypay_settings']               = isset($this->domains) ? $this->safetypaySettings : null;
        $json['facebook_settings']                = isset($this->domains) ? $this->facebookSettings : null;
        $json['general_settings']                 = isset($this->domains) ? $this->generalSettings : null;
        $json['webhook_settings']                 = isset($this->domains) ? $this->webhookSettings : null;
        $json['split_settings']                   = isset($this->domains) ? $this->splitSettings : null;
        $json['subscription_settings']            = isset($this->domains) ? $this->subscriptionSettings : null;
        $json['order_settings']                   = isset($this->domains) ? $this->orderSettings : null;
        $json['notification_settings']            = isset($this->domains) ? $this->notificationSettings : null;
        $json['guaranteed_cancellation_settings'] = isset($this->domains) ? $this->cancellationSettings : null;
        $json['renew_card_settings']              = isset($this->domains) ? $this->renewCardSettings : null;
        $json['cash_Settings']                    = isset($this->domains) ? $this->cashSettings : null;
        $json['checkout_settings']                = isset($this->domains) ? $this->checkoutSettings : null;
        $json['pix_settings']                     = isset($this->domains) ? $this->pixSettings : null;
        return $json;
    }
}
